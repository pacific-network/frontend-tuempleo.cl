...
if (!idOferta) {
  ...
  fetch(`${BASE_URL_API}/postulaciones/oferta/${idOferta}`)
    ...
    .then((postulantes) => {
            ...
            <div class="candidate-item">
              ...
              <div class="candidate-content">
                ...
                <div class="candidate-bottom">
                  ...
                  <div class="profile-btns">
                    <a href="employer-view-candidate.html?id=${usuarioId}" class="btn btn-outline-secondary btn-sm view-btn" data-user-id="${usuarioId}">
      ...
      // Agregar listener a los botones de "ver"
